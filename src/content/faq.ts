export const faqEntries = [
  ...
  },
  {
    ...
    a: "Sangat mudah. Amantubillahi menyediakan layanan pendaftaran online melalui form booking di website ini, dilanjutkan dengan pengiriman dokumen fisik melalui kurir atau tim perwakilan koper lokal kami yang tersebar di Selong, Masbagik, Praya, Sumbawa Besar, dan Kota Bima yang siap mengambil berkas langsung di kediaman Anda."
  },
  {
    q: "Apakah biaya yang tertera di website sudah termasuk perlengkapan dan manasik?",
    a: "Ya, seluruh biaya paket yang kami rilis di Amantubillahi bersifat all-in. Biaya tersebut sudah termasuk perlengkapan umroh seperti koper premium, kain ihram atau mukena, tas selempang, buku doa, visa resmi, makan fullboard catering nusantara, air zam-zam 5L, serta bimbingan manasik intensif 2 kali di NTB sebelum bertolak ke Saudi."
  },
  {
    q: "Apakah ada diskon atau paket khusus untuk pendaftaran rombongan keluarga?",
    a: "Benar sekali. Kami menyediakan kebijakan diskon khusus atau penyesuaian kamar double maupun triple room bagi pendaftaran rombongan keluarga atau rombongan jamaah minimal 4 orang dari satu desa atau kecamatan di Lombok. Konsultasikan kebutuhan rombongan Anda ke tim admin kami via WhatsApp."
  }
] as const;
